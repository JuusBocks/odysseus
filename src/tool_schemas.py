...
FUNCTION_TOOL_SCHEMAS = [
    ...
    },
    {
        ...
        "function": {
            "name": "web_search",
            "description": "Quick single web lookup for a fact or current event mid-task. The query must be standalone: include the subject/context, not vague follow-ups like 'scores' or 'results'. NOT for 'research X' / 'do research on X' — those are deep-research jobs; use trigger_research instead.",
            "parameters": {
                "type": "object",
                "properties": {
    ...
    },
    {
        ...
        "function": {
            "name": "ask_teacher",
            "description": "Ask the configured external teacher model for help with hard planning, review, or synthesis. Summarize the task and replace private values with placeholders before calling; Odysseus also redacts common secrets before sending externally. Required when the user explicitly asks to use/ask the teacher, use a teacher/student flow, or show what was redacted.",
            "parameters": {
                "type": "object",
                "properties": {
